...
function ProfilePage() {
    return (
        <Container className="mt-5 GowunDodum-Regular">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text as="div">
                                <ul className="list-unstyled" style={{textAlign: 'left', paddingLeft: '20px'}}>
                                    ...
                                    <br/>
                                    <li>
                                        <span style={{display: 'inline-block', width: '1em'}}>▷</span> 2019년도부터 약 3년간
                                        대치동
                                        소재의 진학입시교육학원에서 입시 전문 선생님으로 재직하며 생활기록부 관련 지도와 자기소개서 첨삭, 학생부 종합전형 면접 수업 진행 등 여러 대입
                                        관련 업무를
                                        도맡아 왔습니다.
                                    </li>
                                    <br/>
                                    <li>
                                        <span style={{display: 'inline-block', width: '1em'}}>▷</span> 소프트웨어 및 인공지능(AI)을
                                        전공하였으며,
                                        금융공학 관련 데이터 분석 연구실 (Financial Data Science Lab.) 에서의 석사 연구 활동과 더불어 애플리케이션, 웹 등의
                                        IT 플랫폼 탐구·개발 자율동아리를 창설하여 운영하고 있습니다.
                                    </li>
                                    <br/>
                                    <li>
                                        ...
                                        업무를 담당하였습니다. 초·중·고 소프트웨어/인공지능 교육을 위해 교육부와 17개 시도교육청, 한국과학창의재단에서 운영하는 디지털새싹 캠프의
                                        강사로도 활동하고 있습니다.
                                    </li>
                                    <br/>
                                    <li>
                                        ...
                                        Data Analysis 등의 프로그래밍 수업과 AP Computer Science, USACO 등의 유학생 SW 수업, 또 학생부 종합전형 및
                                        AI/SW 전형 대입 면접 수업을
                                        진행하고 있습니다.
                                    </li>
                                    <br/>
                                    <li>
                                        <span style={{display: 'inline-block', width: '1em'}}>▷</span> 2023년 주요 실적 (대입):
                                        한양대 서울캠 SW 특기자 전형 최초합, 국민대 SW 특기자 전형 최초합, 가천대 조기취업형 계약학과 전형 최초합
                                    </li>
                                    <br/>
                                    <li>
                                        <span style={{display: 'inline-block', width: '1em'}}>▷</span> 2024년 주요 실적 (대회 지도 후 수상):
                                        교내 발명품대회, 제3회 국제청소년 한국유네스코유산 알리기 아이디어대회 SW첨단기술부문, Korea-International Youth
                                        Olympiad 2024
                                    </li>
